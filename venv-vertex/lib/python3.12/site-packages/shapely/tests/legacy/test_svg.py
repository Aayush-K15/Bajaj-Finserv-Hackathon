...
class SvgTestCase(unittest.TestCase):
    ...
    def test_point(self):
        ...
        self.assertSVG(
            g,
            '<circle cx="6.0" cy="7.0" r="3.0" stroke="
            'stroke-width="1.0" fill="
        )
        self.assertSVG(
            g,
            '<circle cx="6.0" cy="7.0" r="15.0" stroke="
            'stroke-width="5.0" fill="
            scale_factor=5,
        )
    ...
    def test_multipoint(self):
        ...
        self.assertSVG(
            g,
            '<g><circle cx="6.0" cy="7.0" r="3.0" stroke="
            'stroke-width="1.0" fill="
            '<circle cx="3.0" cy="4.0" r="3.0" stroke="
            'stroke-width="1.0" fill="
        )
        self.assertSVG(
            g,
            '<g><circle cx="6.0" cy="7.0" r="15.0" stroke="
            'stroke-width="5.0" fill="
            '<circle cx="3.0" cy="4.0" r="15.0" stroke="
            'stroke-width="5.0" fill="
            scale_factor=5,
        )
    ...
    def test_collection(self):
        ...
        self.assertSVG(
            ...
            '<g><circle cx="7.0" cy="3.0" r="3.0" stroke="
            'stroke-width="1.0" fill="
            '<polyline fill="none" stroke="
