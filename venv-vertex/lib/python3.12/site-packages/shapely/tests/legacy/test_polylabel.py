...
class PolylabelTestCase(unittest.TestCase):
    ...
    def test_polygon_infinite_loop(self):
        ...
        polygon = shapely.from_wkt(
            "POLYGON ((536520.0679737709 5438764.374763639, 536520.0679737704 5438764.374763602, 536520.0679737709 5438764.374763642, 536520.0679737709 5438764.374763639))"  
        )
        label = polylabel(polygon)
