        ...
        if project_id is None:
            if isinstance(_project_id, str):
                ...
                raise AttributeError(
                    'project_id is required to be specified either as an argument or from the google.auth.default. See https://google-auth.readthedocs.io/en/master/reference/google.auth.html
                )
