...
_module_lookup = {
    ...
    "GoogleCloudEnterpriseSearchRetriever": "langchain_community.retrievers.google_vertex_ai_search",  
    "GoogleDocumentAIWarehouseRetriever": "langchain_community.retrievers.google_cloud_documentai_warehouse",  
    "GoogleVertexAIMultiTurnSearchRetriever": "langchain_community.retrievers.google_vertex_ai_search",  
    "GoogleVertexAISearchRetriever": "langchain_community.retrievers.google_vertex_ai_search",  
    ...
    "QdrantSparseVectorRetriever": "langchain_community.retrievers.qdrant_sparse_vector_retriever",  
    ...
    "WeaviateHybridSearchRetriever": "langchain_community.retrievers.weaviate_hybrid_search",  
