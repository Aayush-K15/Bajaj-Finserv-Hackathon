...
class OracleDocReader:
    ...
    def generate_object_id(input_string: Union[str, None] = None) -> str:
        ...
        timestamp_bin = struct.pack(">I", timestamp)  

        
        hashval_bin = hashlib.sha256(input_string.encode()).digest()
        hashval_bin = hashval_bin[:hash_len]  

        
        counter_bin = struct.pack(">I", random.getrandbits(32))  

        
        object_id = timestamp_bin + hashval_bin + counter_bin  
