...
_module_lookup = {
    ...
    "DatabricksVectorSearch": "langchain_community.vectorstores.databricks_vector_search",  
    ...
    "OpenSearchVectorSearch": "langchain_community.vectorstores.opensearch_vector_search",  
