...
class AsyncFeaturestoreOnlineServingServiceRestTransport(
    ...
    def read_feature_values(
        ...
        return self._ReadFeatureValues(self._session, self._host, self._interceptor)  
    ...
    def streaming_read_feature_values(
        ...
        return self._StreamingReadFeatureValues(self._session, self._host, self._interceptor)  
    ...
    def write_feature_values(
        ...
        return self._WriteFeatureValues(self._session, self._host, self._interceptor)  
