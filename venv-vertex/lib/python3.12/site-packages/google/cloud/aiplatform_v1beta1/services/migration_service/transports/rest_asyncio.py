...
class AsyncMigrationServiceRestTransport(_BaseMigrationServiceRestTransport):
    ...
    def batch_migrate_resources(
        ...
        return self._BatchMigrateResources(self._session, self._host, self._interceptor)  
    ...
    def search_migratable_resources(
        ...
        return self._SearchMigratableResources(self._session, self._host, self._interceptor)  
