...
class AsyncIndexServiceRestTransport(_BaseIndexServiceRestTransport):
    ...
    def import_index(
        ...
        return self._ImportIndex(self._session, self._host, self._interceptor)  
    ...
    def remove_datapoints(
        ...
        return self._RemoveDatapoints(self._session, self._host, self._interceptor)  

    @property
    def update_index(
        self,
    ) -> Callable[[index_service.UpdateIndexRequest], operations_pb2.Operation]:
        return self._UpdateIndex(self._session, self._host, self._interceptor)  
    ...
    def upsert_datapoints(
        ...
        return self._UpsertDatapoints(self._session, self._host, self._interceptor)  
