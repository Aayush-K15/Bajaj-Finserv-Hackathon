...
class TagHoldsRestTransport(_BaseTagHoldsRestTransport):
    ...
    def create_tag_hold(
        ...
        return self._CreateTagHold(self._session, self._host, self._interceptor)  
    ...
    def delete_tag_hold(
        ...
        return self._DeleteTagHold(self._session, self._host, self._interceptor)  
    ...
    def list_tag_holds(
        ...
        return self._ListTagHolds(self._session, self._host, self._interceptor)  
