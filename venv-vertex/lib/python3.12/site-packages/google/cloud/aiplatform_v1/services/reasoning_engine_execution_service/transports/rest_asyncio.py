...
class AsyncReasoningEngineExecutionServiceRestTransport(
    ...
    def query_reasoning_engine(
        ...
        return self._QueryReasoningEngine(self._session, self._host, self._interceptor)  
    ...
    def stream_query_reasoning_engine(
        ...
        return self._StreamQueryReasoningEngine(self._session, self._host, self._interceptor)  
