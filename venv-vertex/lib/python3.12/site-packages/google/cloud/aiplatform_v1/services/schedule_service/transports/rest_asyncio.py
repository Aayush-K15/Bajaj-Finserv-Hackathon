...
class AsyncScheduleServiceRestTransport(_BaseScheduleServiceRestTransport):
    ...
    def create_schedule(
        ...
        return self._CreateSchedule(self._session, self._host, self._interceptor)  

    @property
    def delete_schedule(
        self,
    ) -> Callable[[schedule_service.DeleteScheduleRequest], operations_pb2.Operation]:
        return self._DeleteSchedule(self._session, self._host, self._interceptor)  

    @property
    def get_schedule(
        self,
    ) -> Callable[[schedule_service.GetScheduleRequest], schedule.Schedule]:
        return self._GetSchedule(self._session, self._host, self._interceptor)  
    ...
    def list_schedules(
        ...
        return self._ListSchedules(self._session, self._host, self._interceptor)  

    @property
    def pause_schedule(
        self,
    ) -> Callable[[schedule_service.PauseScheduleRequest], empty_pb2.Empty]:
        return self._PauseSchedule(self._session, self._host, self._interceptor)  

    @property
    def resume_schedule(
        self,
    ) -> Callable[[schedule_service.ResumeScheduleRequest], empty_pb2.Empty]:
        return self._ResumeSchedule(self._session, self._host, self._interceptor)  

    @property
    def update_schedule(
        self,
    ) -> Callable[[schedule_service.UpdateScheduleRequest], gca_schedule.Schedule]:
        return self._UpdateSchedule(self._session, self._host, self._interceptor)  
