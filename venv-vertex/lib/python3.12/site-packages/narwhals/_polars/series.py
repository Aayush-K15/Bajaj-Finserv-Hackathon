...
class PolarsSeries:
    ...
    def __native_namespace__(self) -> ModuleType:
        ...
        msg = f"Expected polars, got: {type(self._implementation)}"  
    ...
    def _bins_from_bin_count(self, bin_count: int) -> pl.Series:  
