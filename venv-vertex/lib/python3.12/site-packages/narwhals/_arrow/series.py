...
def maybe_extract_py_scalar(value: Any, return_py_scalar: bool) -> Any:  
    if TYPE_CHECKING:
        return value.as_py()
    if return_py_scalar:
...
class ArrowSeries(EagerSeries["ChunkedArrayAny"]):
    ...
    def __and__(self, other: Any) -> Self:
        ser, other = extract_native(self, other)
        return self._with_native(pc.and_kleene(ser, other))  

    def __rand__(self, other: Any) -> Self:
        ser, other = extract_native(self, other)
        return self._with_native(pc.and_kleene(other, ser))  

    def __or__(self, other: Any) -> Self:
        ser, other = extract_native(self, other)
        return self._with_native(pc.or_kleene(ser, other))  

    def __ror__(self, other: Any) -> Self:
        ser, other = extract_native(self, other)
        return self._with_native(pc.or_kleene(other, ser))  
    ...
    def __rtruediv__(self, other: Any) -> Self:
        ser, other = extract_native(self, other)
        return self._with_native(pc.divide(*cast_for_truediv(other, ser)))  
    ...
    def __native_namespace__(self) -> ModuleType:
        ...
        msg = f"Expected pyarrow, got: {type(self._implementation)}"  
