...
class BizarroCharacterTest(fixtures.TestBase):
    ...
    def test_fk_ref(
        ...
        quote ' one commentquote " two commentComment types type speedily ' " \ '' Fun!the test % ' " \ table commentthe test % ' " \ table commentComment types type speedily ' " \ '' Fun!test 
    ...
    def test_get_view_definition_does_not_exist(self, connection):
        ...
        with expect_raises(NoSuchTableError):
            insp.get_view_definition("users")  
